	...
	case WM_LBUTTONDOWN:
		{
			...
			if(Server.turn)
			{
				if( BoxSelect(mouse_x, mouse_y, &Server))
				{
...
int WINAPI WinMain(HINSTANCE hinstance, HINSTANCE hprevinstance, LPSTR lpcmdline, int ncmdshow)
{
	...
	if(!(hwnd = CreateWindowEx(NULL, WINDOW_CLASS_NAME, "Tic Tac Toe - Server", WS_OVERLAPPED|WS_SYSMENU|WS_VISIBLE,
