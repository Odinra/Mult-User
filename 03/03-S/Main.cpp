...
//char ClientIP[15] = "161.109.16.137";
IPAddress ClientIP;
char SendData[100];
int SendBytes = 0;
char RecvData[240];
		...
		**************************************************************************/
		...
		do
		{
			do
			{
				...
				RecvBytes = recvfrom(skServer, RecvData, sizeof(RecvData), 0, (struct sockaddr*)&saClient, &clientSize);
			...
			**************************************************************************/
			...
			do{
				...
				printf("%s\n", SendData);
				SendBytes = sendto(skServer, SendData, sizeof(SendData), 0, (struct sockaddr*)&saClient, clientSize);
